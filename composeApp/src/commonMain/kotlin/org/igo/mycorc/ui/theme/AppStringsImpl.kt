...
data class AppStringsImpl(
    ...
    override val confirmPasswordLabel: String,
    ...
    override val orDivider: String,
    override val registerTitle: String,
    override val registerButton: String,
    override val passwordsDoNotMatch: String,
    override val haveAccountText: String,
    override val signInLink: String,
    ...
    override val timeUnitMinutes: String,
    override val deliveryInfoPlaceholder: String,
...
fun rememberAppStrings(languageConfig: org.igo.mycorc.ui.screen.settings.AppLanguageConfig): AppStrings {
    ...
    return AppStringsImpl(
        ...
        confirmPasswordLabel = stringResource(Res.string.confirm_password_label),
        ...
        signInWithGoogle = stringResource(Res.string.sign_in_with_google),
        orDivider = stringResource(Res.string.or_divider),
        registerTitle = stringResource(Res.string.register_title),
        registerButton = stringResource(Res.string.register_button),
        passwordsDoNotMatch = stringResource(Res.string.passwords_do_not_match),
        haveAccountText = stringResource(Res.string.have_account_text),
        signInLink = stringResource(Res.string.sign_in_link),
        ...
        comingSoon = stringResource(Res.string.coming_soon),
        okButton = stringResource(Res.string.ok_button),
        timeUnitMinutes = stringResource(Res.string.time_unit_minutes),
        deliveryInfoPlaceholder = stringResource(Res.string.delivery_info_placeholder),
